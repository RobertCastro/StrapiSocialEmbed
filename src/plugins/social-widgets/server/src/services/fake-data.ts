import type { InstagramPost, TikTokPost, EngagementStats, SupportedPlatform } from '../types';
...
export default ({ strapi }: { strapi: any }) => ({
   ...
   */
  generatePostsByPlatform(platform: SupportedPlatform, count: number): InstagramPost[] | TikTokPost[] {
    switch (platform) {
      case 'instagram':
   ...
   */
  validatePostStructure(posts: InstagramPost[] | TikTokPost[], platform: SupportedPlatform): boolean {
   ...
   */
  getEngagementStats(posts: InstagramPost[] | TikTokPost[], platform: SupportedPlatform): EngagementStats | null {
